...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def _build_model(self):
        ...
        model_img = self.model_dict[self.args_img.model].Model(self.args, self.args_img, self.args_weather).float()
    ...
    def vali(self, vali_data, vali_loader, criterion):
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark, batch_x_img, batch_y_img, batch_x_weather, batch_y_weather) in enumerate(vali_loader):
                ...
                outputs_img = outputs_img[:, -self.args.pred_len:, f_dim:]
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            early_stopping(vali_loss, self.model_img, path, model_name='checkpoint_img.pth')
