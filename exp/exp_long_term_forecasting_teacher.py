...
from utils.metrics import metric, Weighted_MSE_MAE
import torch
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark, batch_x_img, batch_y_img, batch_x_weather, batch_y_weather) in enumerate(vali_loader):
                ...
                if self.args.use_amp:
                    with torch.cuda.amp.autocast():
                        outputs, _, _, _ = self.model(batch_x, batch_x_img, batch_y_img, batch_x_weather, batch_y_weather)
                else:
                    outputs, _, _, _ = self.model(batch_x, batch_x_img, batch_y_img, batch_x_weather, batch_y_weather)
                ...
                loss = criterion(pred, true, self.model)
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark, batch_x_img, batch_y_img, batch_x_weather, batch_y_weather) in enumerate(train_loader):
                ...
                outputs, _, _, _ = self.model(batch_x, batch_x_img, batch_y_img, batch_x_weather, batch_y_weather, self.args.fuse_strategy)
