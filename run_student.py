...
from exp.exp_long_term_forecasting_student import Exp_Long_Term_Forecast
...
if __name__ == '__main__':
    ...
    # Multi-modal fusion parameters (hardcoded in MTS_31F model)
    ...
    args_weather.enc_in = args.weather_feature_dim  
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_imgdim{}_weatherdim{}_{}_{}_{}'.format(
                args.task_name,
                args.model_id,
                args.model,
                args.data,
